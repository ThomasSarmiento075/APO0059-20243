...
def main():
    ...
    if opcion == 1:
        print("El resultado de tu operación es:", calc.suma(num1, num2))
    elif opcion == 2:
        print("El resultado de tu operación es:", calc.resta(num1, num2))
    elif opcion == 3:
        print("El resultado de tu operación es:", calc.multiplicacion(num1, num2))
    elif opcion == 4:
        print("El resultado de tu operación es:", calc.division(num1, num2))
    else:
